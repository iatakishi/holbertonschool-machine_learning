#!/usr/bin/env python3
"""
Module for loading, tokenizing, and encoding the Portuguese to English
translation dataset with TensorFlow wrappers.
"""
...
class Dataset:
    ...
    def __init__(self):
        ...
        Initializes datasets, creates tokenizers,
        and applies tf_encode to the datasets.
        """
