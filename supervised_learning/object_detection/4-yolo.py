#!/usr/bin/env python3
"""
Class Yolo that initiates, processes, filters, applies NMS, and loads images.
"""
import glob
import cv2
import numpy as np
...
class Yolo:
    ...
    def load_images(folder_path):
        ...
        # the directory path using glob wildcard
        # To make sure we capture files properly,
        # we can append '*' if needed
